...
public class Numbers {
	...
	public static void main(String[] args) throws Exception {
        ...
        //bubble sort
		 ...
		 System.out.println("Total Execution Time of "+num.length+" numbers in bublle sor take: "+bubbleSortExecutionTime+" milli sec");
		 connectToSqlDB.insertDataFromArrayToSqlTable(num,"bubblr-sort","SortingNumber");
